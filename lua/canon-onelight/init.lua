local variants = require("canon-onelight.colors")
local utils = require("canon-onelight.utils")
local cfg = require("canon-onelight.config").config
...
local set_groups = function()
    local highlights = {
        ...
        { hg = "Boolean", fg = c.base09, bg = c.none, gui = cfg.boolean_style },
        { hg = "@boolean", fg = c.base09, bg = c.none, gui = cfg.boolean_style },
        { hg = "Float", fg = c.base09, bg = c.none },
        { hg = "Identifier", fg = c.base08, bg = c.none },
        ...
        { hg = "@keyword", fg = c.base0E, bg = c.none, gui = cfg.keyword_style },
        { hg = "@keyword.function", fg = c.base0E, bg = c.none, gui = cfg.function_style },
        { hg = "@keyword.return", fg = c.base0E, bg = c.none },
        { hg = "@keyword.operator", fg = c.base0E, bg = c.none },
        { hg = "@keyword.conditional", fg = c.base0E, bg = c.none, gui = cfg.keyword_style },
        { hg = "@keyword.conditional.ternary", fg = c.base0E, bg = c.none, gui = cfg.keyword_style },
        ...
        { hg = "@function", fg = c.base0D, bg = c.none, gui = cfg.function_style },
        { hg = "@function.builtin", fg = c.base0D, bg = c.none, gui = cfg.function_style },
        { hg = "@function.macro", fg = c.base08, bg = c.none, gui = cfg.function_style },
        { hg = "@function.call", fg = c.base0D, bg = c.none, gui = cfg.function_style },
        { hg = "@function.method", fg = c.base0D, bg = c.none, gui = cfg.function_style },
        { hg = "@function.method.call", fg = c.base0D, bg = c.none, gui = cfg.function_style },
        ...
        { hg = "@variable.builtin", fg = c.base09, bg = c.none,  },
        { hg = "@variable.parameter", fg = c.base08, bg = c.none, },
...
M.colorscheme = function()
    ...
    vim.g.colors_name = "canon-onelight"
