local variants = require("canon-dark_horizon.colors")
local utils = require("canon-dark_horizon.utils")
local cfg = require("canon-dark_horizon.config").config
...
M.colorscheme = function()
    ...
    vim.g.colors_name = "canon-dark_horizon"
