...
local set_groups = function()
    local highlights = {
        ...
        -- Markdown
        { hg = "@markup.heading.1.markdown", fg = c.white, gui = "bold" },
        { hg = "@markup.heading.2.markdown", fg = c.cyan, gui = "bold" },
        { hg = "@markup.heading.3.markdown", fg = c.gray_blue, gui = "bold" },
        { hg = "@markup.heading.4.markdown", fg = c.blue, gui = "bold" },
        { hg = "@markup.heading.5.markdown", fg = c.green, gui = "bold" },
        { hg = "@markup.heading.6.markdown", fg = c.magenta, gui = "bold" },
        { hg = "@markup.heading.1.marker.markdown", fg = c.white, gui = "bold" },
        { hg = "@markup.heading.2.marker.markdown", fg = c.cyan, gui = "bold" },
        { hg = "@markup.heading.3.marker.markdown", fg = c.gray_blue, gui = "bold" },
        { hg = "@markup.heading.4.marker.markdown", fg = c.blue, gui = "bold" },
        { hg = "@markup.heading.5.marker.markdown", fg = c.green, gui = "bold" },
