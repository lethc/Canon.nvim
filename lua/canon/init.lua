...
local set_groups = function()
  local highlights = {
    ...
    -- Markdown
    { hg = "@markup.heading.1.markdown", fg = c.yellow, gui = "bold"  },
    ...
    { hg = "@markup.heading.1.marker.markdown", fg = c.yellow  },
    { hg = "@markup.heading.2.marker.markdown", fg = c.cyan  },
    { hg = "@markup.heading.3.marker.markdown", fg = c.green  },
    { hg = "@markup.heading.4.marker.markdown", fg = c.blue },
    { hg = "@markup.heading.5.marker.markdown", fg = c.gray_blue },
    { hg = "@markup.heading.6.marker.markdown", fg = c.magenta  },
