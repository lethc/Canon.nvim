...
local set_groups = function()
    local highlights = {
        ...
        -- Neogit
        { "NeogitNotificationInfo", fg = c.bright_green },
        { "NeogitNotificationWarning", fg = c.bright_yellow },
        { "NeogitNotificationError", fg = c.bright_red },
        { "NeogitDiffAddHighlight", fg = c.bright_green, bg = c.dark_green },
        { "NeogitDiffDeleteHighlight", fg = c.bright_red, bg = c.dark_red },
        { "NeogitDiffContextHighlight", fg = c.fg, bg = c.alt_bg },
        { "NeogitHunkHeader", fg = c.fg, bg = c.alt_bg },
        { "NeogitHunkHeaderHighlight", fg = c.fg, bg = c.bright_black },
        { "NeogitDiffAdd", fg = c.bright_green, bg = c.dark_green },
        { "NeogitDiffDelete", fg = c.bright_red, bg = c.dark_red },
        { "NeotestAdapterName", fg = c.magenta },
        { "NeotestDir", fg = c.cyan },
        { "NeotestExpandMarker", fg = c.gray02 },
        { "NeotestFailed", fg = c.bright_red },
        { "NeotestFile", fg = c.cyan },
        { "NeotestFocused", gui = "bold" },
