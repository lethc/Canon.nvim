local variants = require("canonl.colors")
local utils = require("canonl.utils")
local cfg = require("canonl.config").config
...
local set_groups = function()
    local highlights = {
        ...
        { hg = "Constant", fg = c.pink }, -- any constant
        { hg = "String", fg = c.medium_gray_blue }, -- a string constant: "this is a string"
        { hg = "Character", fg = c.green }, -- a character constant: 'c', '\n'
        { hg = "Number", fg = c.bright_cyan }, -- a number constant: 234, 0xff
        { hg = "Boolean", fg = c.bright_cyan, cfg.boolean_style }, -- a boolean constant: TRUE, false
        ...
        { hg = "PreProc", fg = c.magenta2 }, -- generic Preprocessor
        { hg = "Include", fg = c.bright_cyan }, -- preprocessor #include
        ...
        { hg = "LineNr", fg = c.bright_white }, -- Line number for " =number" and ":#" commands, and when 'number' or 'relativenumber' option is set.
        ...
        -- Tree sitter
        { hg = "@boolean", fg = c.bright_cyan, gui = cfg.boolean_style },
        ...
        { hg = "@punctuation.bracket", fg = c.pink },
        ...
        { hg = "@markup.heading.2.markdown", fg = c.orange, gui = "bold" },
        { hg = "@markup.heading.2.marker.markdown", fg = c.orange, gui = "bold" },
        ...
        { hg = "markdownCodeBlock", fg = c.cyan, gui = "bold" },
        { hg = "@markup.strong.markdown_inline", fg = c.fg, gui = "bold" },
        { hg = "@markup.strong", fg = c.fg, gui = "bold" },
        { hg = "@markup.italic.markdown_inline", fg = c.medium_gray_blue, gui = "italic" },
        { hg = "@markup.quote.markdown", fg = c.bright_white, bg = c.gray09, gui = "bold,italic" },
        ...
        -- Telescope
        { hg = "TelescopeMatching", fg = c.pink, gui = "bold" },

        -- Flash
        { hg = "FlashBackdrop", fg = c.gray06 },
        { hg = "FlashLabel", bg = c.pink, fg = c.bg, gui = "bold" },

        -- FZF-lua
        { hg = "FzfLuaNormal", bg = c.black, fg = c.fg },
        { hg = "FzfLuaTitle", bg = c.black, fg = c.fg, gui = "bold" },
        { hg = "FzfLuaBorder", bg = c.black, fg = c.orange },
        { hg = "FzfLuaPreviewBorder", bg = c.black, fg = c.orange },
